                            ...
                            <div className="col-lg-9 favourites-table col-sm-12">
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col"><i class="fas fa-sort-up" onClick={this.sortPopularityDesc} style={{cursor:'pointer'}}/>Popularity<i class="fas fa-sort-down" onClick={this.sortPopularityAsc} style={{cursor:'pointer'}}></i></th>
                                                <th scope="col"><i class="fas fa-sort-up" onClick={this.sortRatingDesc} style={{cursor:'pointer'}}></i>Rating<i class="fas fa-sort-down" onClick={this.sortRatingAsc} style={{cursor:'pointer'}}></i></th>
                                                <th scope="col"></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination">
                                        {
                                            pagesarr.map((page) => (
                                                <li class="page-item"><a class="page-link" style={{cursor:'pointer'}} onClick={() => this.handlePageChange(page)}>{page}</a></li>
                                            ))
                                        }
                                    </ul>
                                </nav>
